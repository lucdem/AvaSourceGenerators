...
public class StyledPropertyGeneratorTests
{
    ...
    [Fact]
    public void StyledPropertyWithNonNullableType()
    {
        const string input =
        """
        using Lucdem.Avalonia.SourceGenerators.Attributes;
    ...
    [Fact]
    public void StyledPropertyWithLeadingUnderscoreField()
    {
        const string input =
        """
        using Lucdem.Avalonia.SourceGenerators.Attributes;
    ...
    [Fact]
    public void MultipleStyledPropertiesInSameFile()
    {
        const string input =
        """
        using Lucdem.Avalonia.SourceGenerators.Attributes;
        ...
        namespace MyNamespace
        {
            ...
            partial class MyClass
            {
                ...
                public static readonly global::Avalonia.StyledProperty<string> MyStrProperty = global::Avalonia.AvaloniaProperty.Register<MyClass, string>("MyStr");
                [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
                [global::System.CodeDom.Compiler.GeneratedCode("Lucdem.Avalonia.SourceGenerators.Generators.StyledPropertyGenerator", "{{_assemblyVersion}}")]
                public string MyStr { get => GetValue(MyStrProperty); set => SetValue(MyStrProperty, value); }
            }
        }
        """;
